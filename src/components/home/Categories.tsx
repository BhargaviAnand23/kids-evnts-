...
const parentCategoryHubs = [
  {
    ...
    photo: '/images/sports-hub.jpg',
    overlay: 'bg-gradient-to-t from-emerald-950/95 via-emerald-900/70 to-transparent',
    icon: '⚽',
  ...
  },
  {
    ...
    photo: '/images/talents-hub.jpg',
    overlay: 'bg-gradient-to-t from-purple-950/95 via-purple-900/70 to-transparent',
    icon: '🎨',

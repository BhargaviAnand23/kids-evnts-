...
export function TrendingEvents() {
  ...
  const gridColsClass =
    count === 1
      ...
      : count === 2
      ? 'grid-cols-1 xxs:grid-cols-2 md:grid-cols-2 max-w-3xl mx-auto'
      : count === 3
      ? 'grid-cols-1 xxs:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 max-w-5xl mx-auto'
      : 'grid-cols-1 xxs:grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4';
      ...
      <div className="max-w-screen-2xl mx-auto px-4 sm:px-6 md:px-8 lg:px-12 mb-10">
        ...
        {events.length === 0 ? (
          ...
          <motion.div
            ...
            className={`grid gap-3 xxs:gap-4 sm:gap-6 lg:gap-8 ${gridColsClass}`}
          >

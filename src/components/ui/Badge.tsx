...
export function Badge({ className = '', variant = 'default', ...props }: BadgeProps) {
  const baseStyles = "inline-flex items-center px-2.5 py-0.5 text-caption font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2";
  ...
  const variants = {
    ...
    pill: "border-transparent bg-white/90 backdrop-blur-sm text-slate-800 rounded-full shadow-sm py-2 px-4 text-caption",
  };

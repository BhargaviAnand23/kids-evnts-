  ...
  return (
    <div className="bg-slate-50 min-h-screen py-10 sm:py-14 md:py-16 px-6 md:px-16 lg:px-24">
      <div className="max-w-4xl mx-auto bg-white rounded-3xl p-6 sm:p-10 shadow-sm border border-slate-100">
        ...
        <h1 className="text-page-title font-bold text-slate-900 mb-6 md:mb-8">Refund Policy</h1>
        ...
        <div className="prose prose-slate max-w-none text-slate-600 leading-relaxed text-body space-y-6">
          ...
          <h2 className="text-section-title font-bold text-slate-900 pt-4 border-t border-slate-100">1. Parent Cancellations</h2>
          ...
          <h2 className="text-card-title font-bold text-slate-900 pt-4 border-t border-slate-100">2. Organizer Cancellations & Rescheduling</h2>
          <p>
          ...
          <h2 className="text-card-title font-bold text-slate-900 pt-4 border-t border-slate-100">3. How Refunds Are Processed</h2>
          <p>
